...
<li>## 1. Dérivation et justification du profil parabolique de cisaillement</li></ol>
...
### 1.2. Choix de la géométrie et conditions aux limites
...
### 1.3. Détermination analytique des coefficients
...
### 1.4. Expression du taux de cisaillement local
...
### 1.5. Passage au paramètre adimensionnel $\alpha$
...
### 1.6. Conséquences sur la dynamique de rotation numérique
...
### 1.7. Justification physique du choix du modèle
